...
1. pom.xml에서 Spring-JDBC를 사용하기 위해 의존설정
...
2. sevlet-context.xml에서 빈생성
 ...
 3. 요청명을 결정하고, 컨트롤러를 생성한다.
 	servlet-context.xml 에서 기본패키지를 아래와 같이 추가
 	(반드시 필요한건 아님)
 	<context:component-scan base-package="springboard" />
 	
 4. Service객체, DAO객체를 생성.
 	Service는 컨트롤러와 모델 사이에서 중재역할을 하는 객체로서
 ...
 5. 게시판 구현에 필요한 객체들을 new 를 통해 생성하지 않고
 	주입(DI)을 통해 구현. 이때 @Autowired를 사용.
 	컨트롤러에서는 DAO객체와 각 Service객체를 주입받아 사용.
